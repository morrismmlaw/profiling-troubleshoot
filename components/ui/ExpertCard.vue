    ...
    <div>
      <div class="container">
        <div class="row" style="margin-top: 5px;">
          <div class="col-md-3">
            <div><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                style="font-size: 224px;border-radius: 80px;">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  fill="currentColor"></path>
              </svg><label class="form-label" style="padding-left: 44px;"><svg class="bi bi-hdd-network"
                  xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16"
                  style="font-size: 27px;margin-right: 5px;">
                ...
                </svg><a href="#" style="padding: 4px;font-weight: bold;font-size: 18px;">View Network</a></label></div>
          </div>
          <div class="col-md-8">
            <div>
              <div class="row">
                <div class="col">
                  <div>
                    <h1 style="font-size: 22px;line-height: 25.8px;">Mr John Smith</h1>
                    <div><label class="form-label" style="margin-right: 5px;"><svg class="bi bi-book"
                          ...
                          style="font-size: 16px;height: auto;padding: 0px;padding-top: 0px;padding-bottom: 0px;">Graduate
                          Researcher</sub></label><label class="form-label"><svg class="bi bi-star-fill"
                          xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                          viewBox="0 0 16 16"
                          style="font-size: 22px;margin: 0px;margin-right: 5px;width: 20px;height: 20px;">
                          <path
              ...
              <div class="row">
                <div class="col">
                  <div>
                    <div style="padding-bottom: 5px;"><sub style="font-size: 14px;">Biography</sub></div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div>
                    <div class="row">
                      <div class="col"><label class="col-form-label" style="font-weight: bold;">Field of
                          Research:</label></div>
                    </div>
                    <div class="row">
                      <div class="col"><label class="col-form-label" style="font-weight: bold;">Area / Faculty:</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col"><label class="col-form-label" style="font-weight: bold;">Department /
                          School:</label></div>
                    </div>
                    <div class="row">
                      <div class="col"><label class="col-form-label" style="font-weight: bold;">Strategic Research and
                          innovation Centre:</label></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col">
                  <div style="margin-top: -1px;padding-top: 5px;"><label class="form-label"
                      style="padding: 0px;padding-top: 0px;margin-top: 5px;"><small class="form-text"
                        style="margin: 0px;margin-top: 0px;height: 0px;margin-right: 0px;margin-left: 0px;padding: 0px;padding-top: 0px;"><svg
