                  ...
                  <div class="col">
                    <div>
                      ...
                      <div><label class="form-label" style="margin-right: 5px;"><svg class="bi bi-book"
                            ...
                            style="font-size: 13px;height: auto;padding: 0px;padding-top: 0px;padding-bottom: 0px;">Graduate
                            Researcher (Position)</sub></label><label class="form-label"><svg class="bi bi-star-fill"
                            xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                            viewBox="0 0 16 16"
                            style="font-size: 22px;margin: 0px;margin-right: 5px;width: 20px;height: 20px;">
                            <path
                            ...
                            style="font-size: 13px;height: auto;padding: 0px;padding-top: 0px;padding-bottom: 0px;">Faculty
                            of Art (Faculty)</sub></label></div>
                    </div>
                  </div>
                </div>
                <div class="row">
