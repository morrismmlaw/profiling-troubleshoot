          ...
          <div class="row">
            <div class="col-md-3">
              <div><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                  ...
                  </svg><a href="#" style="padding: 4px;font-weight: bold;font-size: 18px;">View Network</a></label>
              </div>
            </div>
            <div class="col-md-8">
              <div>
                ...
                <div class="row">
                  <div class="col">
                    <div>
                      <div class="row">
                        <div class="col"><label class="col-form-label">Field of Research:</label></div>
                      </div>
                      <div class="row">
                        <div class="col"><label class="col-form-label">Area / Faculty:</label></div>
                      </div>
                      <div class="row">
                        <div class="col"><label class="col-form-label">Department / School:</label></div>
                      </div>
                      <div class="row">
                        <div class="col"><label class="col-form-label">Strategic Research and innovation Centre:</label>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col">
                    <div style="margin-top: -1px;"><label class="form-label"><small class="form-text"
                          style="margin: 0px;margin-top: 0px;height: 0px;margin-right: 0px;margin-left: 0px;"><svg
