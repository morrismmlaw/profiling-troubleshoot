                  ...
                  <div v-if="matchedFields.length" class="publication-match"><label class="form-label publication-label"><small
                        class="form-text"><svg class="publication-icon" xmlns="http://www.w3.org/2000/svg" width="1em"
                          ...
                          <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="currentColor"></path>
                        </svg>Your search matched against this person&#39;s {{ 
...
interface Profile {
  ...
  research_interest: ResearchItem[];
  research_awards: ResearchItem[];
...
const matchedFieldsName = computed(() => {
  return matchedFields.value.map(item => item.field).join(', ');
});
