  ...
  <div class="container-fluid nav-offset">
    ...
    <div class="container-fluid m-1 p-1">
      ...
      <div class="container-fluid"
        style="border-color: var(--bs-primary);margin: 0px;margin-right: 0;margin-left: 0;padding: 0px;padding-right: 5vw;padding-left: 5vw;width: 100%;">
        <div class="row" style="margin-top: 27px;margin-bottom: 10px;">
          <div class="col"><small class="form-text"
              style="color: var(--bs-black);font-size: 20px;font-family: Lato, sans-serif;font-weight: bold;margin-top: 0px;padding: 15px;padding-top: 0px;height: 0px;">FILTERED
              BY</small></div>
          <div class="col-xl-6">
            <div class="row">
              <div class="col">
                <div class="dropdown show" style="width: 15vw;"><button class="btn btn-primary dropdown-toggle"
                  ...
                  <div class="dropdown-menu show" data-bs-popper="none"><a class="dropdown-item"
                      href="#">Relevance</a><a class="dropdown-item" href="#">Name</a><a class="dropdown-item"
                      href="#">Department</a></div>
                </div>
              </div>
              <div class="col">
                <nav>
