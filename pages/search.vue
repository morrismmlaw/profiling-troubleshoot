          ...
          <div id="myInputSearch"
            ...
            <label class="form-label" style="width: 100%;margin-top: 0px;">
              <NuxtLink to="/search" @click="handleSearch">
                <svg class="text-black" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                  fill="none" style="margin-left: 14px;font-size: 30px;margin-top: -3px;color: var(--bs-secondary);">
