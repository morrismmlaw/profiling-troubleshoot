                      ...
                      <div id="myInputSearch"
                        ...
                        <label class="form-label" style="width: 100%;margin-top: 0px;">
                          <NuxtLink to="/search" @click="handleSearch">
                            <svg class="text-black icon-hover" xmlns="http://www.w3.org/2000/svg" width="1em"
                              height="1em" viewBox="-2 -3 30 30" fill="none"
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown">
                              <svg class="text-black icon-hover dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="-3 -3 30 30"
                                fill="none"
