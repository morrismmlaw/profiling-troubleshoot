                ...
                <div class="row">
                  <div class="col-12 mb-2 mb-md-0">
                    ...
                    <div id="myInputSearch"
                      style="margin-left: 1px;background: var(--bs-light);border-radius: 41px;box-shadow: inset 1px 1px 5px 1px;margin-top: 1px;">
                      <label class="form-label" style="width: 100%;"><a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                            width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                            style="margin-left: 14px;font-size: 22px;margin-top: -3px;color: var(--bs-secondary);">
                          ...
                          style="margin-left: 7px;margin-top: 8px;width: calc(100% - 85px);border-style: none;background: var(--bs-light);"
                          placeholder="Search by name or keyword" /><a href="#"><svg xmlns="http://www.w3.org/2000/svg"
                            width="1em" height="1em" viewBox="0 0 24 24" fill="none"
                            style="font-size: 25px;margin-top: -4px;color: var(--bs-secondary);">
                            <path
